...
export default function FormFieldImage({ className = "", label, imgSrc, onClickCallback }) {
  ...
  return (
    <div className={`${styles.formField} ${className}`} onClick={handleClick}>
      ...
      <button className={styles.button} type="button">
        ...
        <img className={styles.buttonImage} src={src}></img>
