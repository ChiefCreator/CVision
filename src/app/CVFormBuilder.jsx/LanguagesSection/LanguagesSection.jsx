      ...
      <div className={styles.sectionBody}>
        <div className={styles.sectionFormGroups}>
          <FormGroup gridTemplateColumns="1fr 1fr" gridTemplateRows="1fr">
            <FormGroupCell>
              <FormField label="Язык" inputValue={isResumeDataLoaded && data.language ? data.language : ""} inputPlaceholder="Введите язык" onChangeInputCallback={(value) => handleFormFieldInputChange("language", value)} />
            </FormGroupCell>
            <FormGroupCell>
              <FormField
                Component={Select}
                ...
                inputValue={isResumeDataLoaded && data.languageLevel ? data.languageLevel : ""}
