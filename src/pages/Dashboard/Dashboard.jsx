...
export default function Dashboard() {
  ...
  const [isDropdownMenuCreateDocumentOpen, setIsDropdownMenuCreateDocumentOpen] = useState(false);
  ...
  function handleButtonAddDocument() {
    setIsDropdownMenuCreateDocumentOpen(prev => !prev);
  }
  ...
  return (
    ...
    <div>
      ...
      <DropdownMenu
        ...
        isOpen={isDropdownMenuCreateDocumentOpen}
        setIsOpen={setIsDropdownMenuCreateDocumentOpen}
