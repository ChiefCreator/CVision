...
import type { SectionsMap } from "@/types/resumeSection/section";

interface SectionDataT {
  name: ResumeSectionName;
  data: SectionsMap[ResumeSectionName];
  order?: number;
};

export function getReorderedSections(resume: Resume, selectedSectionNames?: ResumeSectionName[]) {
