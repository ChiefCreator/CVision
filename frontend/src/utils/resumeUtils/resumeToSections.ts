...
export function resumeToSections(resume: Resume) {
  const { id, title, createdAt, updatedAt, customSections, ...rest } = resume;
  ...
  // Удаление поля order, если оно не нужно в итоговом объекте
