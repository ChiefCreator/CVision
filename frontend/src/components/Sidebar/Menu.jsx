...
export default function Menu({ defaultActiveItemId }) {
      ...
      children: [
        {
          ...
          menuItem: {
            title: "Резюме",
            onClickCallback: () => navigate("/resumes"),
  ...
  const [activeItemId, setActiveItemId] = useState(pathname === "/" ? defaultActiveItemId : findByPathname(data, pathname)?.id);
