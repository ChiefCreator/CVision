...
export default function EditableTitle({ className, children, onChangeCallback, placeholder = "Без названия", isInputFocused = false,  fontSize = 16, ref }) {
  ...
  return (
    <div className={`${styles.editableTitle} ${className ? className : ""}`} style={{ fontSize }}>
