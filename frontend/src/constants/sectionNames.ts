import type { ResumeSectionName, ResumeSingleSectionName, ResumeListSectionName, ResumeDefaultSectionName, ResumeReorderedSectionNames  } from "@/types/resumeTypes";
...
export const SECTION_REORDERED_NAMES: ResumeReorderedSectionNames[] = ["employmentHistory", "education", "skills", "languages", "links", "courses", "internships", "hobbies", "extraCurricularActivities", "references", "customSections"];
