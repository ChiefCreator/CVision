...
export function ChangeEmailTemplate({ domain, token }: ConfirmationTemplateProps) {
		...
		<Tailwind>
			<Html>
				<Body className="text-black">
					<Heading>Изменение почты</Heading>
					<Text>
						Привет! Чтобы изменить свой адрес электронной почты, пожалуйста, перейдите по следующей ссылке:
					</Text>
